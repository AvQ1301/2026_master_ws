...
#resume-item[
  - Led initial investigation into soft actuation technology using Shape Memory Alloy artificial muscles
  - Designed and implemented testing system using Microcontroller, Motor Driver, and Force Sensor
  - Conducted comprehensive literature review on artificial muscle technologies, identifying key advancements and research gaps
  - Investigated linear regression (supervised learning) to predict SMA artificial muscle behavior
  - Managed project progress with reports and Gantt charts
]
